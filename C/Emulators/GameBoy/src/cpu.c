...
void opcodes(uint8_t opcode) {
    switch(opcode) {
        ...
        case(0XCE): ADC(mem_read(cpu.PC++), 1); break;
        ...
        case(0X87): ADD(cpu.AF.upper, 0); break;

        case(0XC6): ADD(mem_read(cpu.PC++), 1); break;
        ...
        // AND
        case(0XA0): AND(cpu.BC.upper, 0); break;
        case(0XA1): AND(cpu.BC.lower, 0); break;
        case(0XA2): AND(cpu.DE.upper, 0); break;
        case(0XA3): AND(cpu.DE.lower, 0); break;
        case(0XA4): AND(cpu.HL.upper, 0); break;
        case(0XA5): AND(cpu.HL.lower, 0); break;
        case(0XA7): AND(mem_read(cpu.HL.full), 1); break;
        case(0XA6): AND(cpu.AF.upper, 0); break;

        case(0XE6): AND(mem_read(cpu.PC++), 1); break;

        // CALL
        case(0XCD): CALL(); break;
        case(0XC4): CALLCC(!FZ); break;
        case(0XD4): CALLCC(!FC); break;
        case(0XCC): CALLCC(FZ); break;
        case(0XDC): CALLCC(FC); break;
        ...
        // JP
        case(0XC3): JP(); break;
        case(0XC2): JPCC(!FZ); break;
        case(0XD2): JPCC(!FC); break;
        case(0XCA): JPCC(FZ); break;
        case(0XDA): JPCC(FC); break;
        ...
        case(0X60): LDr8(&cpu.HL, cpu.BC.upper, 1); break;
        case(0X61): LDr8(&cpu.HL, cpu.BC.lower, 1); break;
        case(0X62): LDr8(&cpu.HL, cpu.DE.upper, 1); break;
        case(0X63): LDr8(&cpu.HL, cpu.DE.lower, 1); break;
        case(0X64): LDr8(&cpu.HL, cpu.HL.upper, 1); break;
        case(0X65): LDr8(&cpu.HL, cpu.HL.lower, 1); break;
        case(0X66): LDr8(&cpu.HL, mem_read(cpu.HL.full), 1); break;
        case(0X67): LDr8(&cpu.HL, cpu.AF.upper, 1); break;

        case(0X68): LDr8(&cpu.HL, cpu.BC.upper, 0); break;
        case(0X69): LDr8(&cpu.HL, cpu.BC.lower, 0); break;
        case(0X6A): LDr8(&cpu.HL, cpu.DE.upper, 0); break;
        case(0X6B): LDr8(&cpu.HL, cpu.DE.lower, 0); break;
        case(0X6C): LDr8(&cpu.HL, cpu.HL.upper, 0); break;
        case(0X6D): LDr8(&cpu.HL, cpu.HL.lower, 0); break;
        case(0X6E): LDr8(&cpu.HL, mem_read(cpu.HL.full), 0); break;
        case(0X6F): LDr8(&cpu.HL, cpu.AF.upper, 0); break;
        ...
        case(0X78): LDr8(&cpu.AF, cpu.BC.upper, 1); break;
        case(0X79): LDr8(&cpu.AF, cpu.BC.lower, 1); break;
        case(0X7A): LDr8(&cpu.AF, cpu.DE.upper, 1); break;
        case(0X7B): LDr8(&cpu.AF, cpu.DE.lower, 1); break;
        case(0X7C): LDr8(&cpu.AF, cpu.HL.upper, 1); break;
        case(0X7D): LDr8(&cpu.AF, cpu.HL.lower, 1); break;
        case(0X7E): LDr8(&cpu.AF, mem_read(cpu.HL.full), 1); break;
        case(0X7F): LDr8(&cpu.AF, cpu.AF.upper, 1); break;
        ...
        case(0X12): LDr16A(cpu.DE.full); break;
...
void prefixed(uint8_t opcode) {
    ...
    switch(opcode & 0X0F) {
        case(0X00): reg = &cpu.BC; upper = 1; cpu.clock += 8; break;
        case(0X01): reg = &cpu.BC; upper = 0; cpu.clock += 8; break;
        case(0X02): reg = &cpu.DE; upper = 1; cpu.clock += 8; break;
        case(0X03): reg = &cpu.DE; upper = 0; cpu.clock += 8; break;
        case(0X04): reg = &cpu.HL; upper = 1; cpu.clock += 8; break;
        case(0X05): reg = &cpu.HL; upper = 0; cpu.clock += 8; break;
        case(0X07): reg = &cpu.AF; upper = 1; cpu.clock += 8; break;

        case(0X08): reg = &cpu.BC; upper = 1; cpu.clock += 8; break;
        case(0X09): reg = &cpu.BC; upper = 0; cpu.clock += 8; break;
        case(0X0A): reg = &cpu.DE; upper = 1; cpu.clock += 8; break;
        case(0X0B): reg = &cpu.DE; upper = 0; cpu.clock += 8; break;
        case(0X0C): reg = &cpu.HL; upper = 1; cpu.clock += 8; break;
        case(0X0D): reg = &cpu.HL; upper = 0; cpu.clock += 8; break;
        case(0X0F): reg = &cpu.AF; upper = 1; cpu.clock += 8; break;

        case(0X06): cpu.clock += 16; break;
        case(0X0E): cpu.clock += 16; break;
    }
