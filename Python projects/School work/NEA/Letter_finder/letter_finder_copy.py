...
def boundingBox(contours, imgCont):
...
def ROI(imgCont, path_final, imgFinal, rect_d):
    i=0
...
def character_extraction(img_path):
    parent_path, final_directory= r'D:\My folder\Programming\Python projects\School work\NEA\images', 'final'
    ...
    rect_d = boundingBox(contours=contours, imgCont=imgCont)
    roi_n = ROI(imgCont, path_final, imgFinal, rect_d)

    return path_final, roi_n
